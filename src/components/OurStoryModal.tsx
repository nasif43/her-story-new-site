...
export const OurStoryModal: React.FC<OurStoryModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-black/40 border border-white/10 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 my-8 max-h-[85vh] flex flex-col font-serif-editorial">
        {/* Header */}
        <div className="p-4 border-b border-white/10 flex items-center justify-between bg-black/20 font-sans-ui">
        ...
        {/* Content */}
        <div className="p-6 md:p-8 overflow-y-auto space-y-6 text-sm text-white leading-relaxed">
          ...
          {/* Stats Bar */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-black/20 rounded-xl text-center font-sans-ui">
            <div>
              <p className="text-2xl font-bold text-[#D64E0E]">2017</p>
              <p className="text-[11px] text-white/80 uppercase font-semibold">Founded</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-[#D672CE]">45k+</p>
              <p className="text-[11px] text-white/80 uppercase font-semibold">Books Distributed</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-[#a53700]">120+</p>
              <p className="text-[11px] text-white/80 uppercase font-semibold">Artisan Fellows</p>
            </div>
            <div>
              <p className="text-2xl font-bold text-[#380d00]">4</p>
              <p className="text-[11px] text-white/80 uppercase font-semibold">Global Awards</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-sans-ui text-white/80">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-white/10 bg-black/20 flex justify-end font-sans-ui">
          <button
            onClick={onClose}

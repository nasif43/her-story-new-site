...
export const OurStoryModal: React.FC<OurStoryModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#261814]/70 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-[#fff8f6] border border-white/10 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 my-8 max-h-[85vh] flex flex-col font-serif-editorial">
        {/* Header */}
        <div className="p-4 border-b border-[#ffe9e3] flex items-center justify-between bg-black/20 font-sans-ui">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-[#ffe9e3] bg-black/20 flex justify-end font-sans-ui">
          <button
            onClick={onClose}

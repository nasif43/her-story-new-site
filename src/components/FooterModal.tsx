  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-black/40 border border-white/10 w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 font-sans-ui">
        ...
        {/* Modal Body */}
        <div className="p-6 overflow-y-auto max-h-[75vh] font-serif-editorial text-sm text-white space-y-4">
          {type === 'contact' && (
            sent ? (
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4 font-sans-ui text-xs">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/20 border border-white/10 p-3 rounded-lg text-sm text-white focus:outline-none focus:border-[#D64E0E]"
                  />
                </div>
          ...
          {type === 'privacy' && (
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-1 text-xs font-sans-ui text-white/80">
          ...
          {type === 'newsletter' && (
            <div className="space-y-3">
              ...
              <p className="text-xs font-sans-ui text-white/80 italic">
